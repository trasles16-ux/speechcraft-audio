...
; ==================== PAGE SEQUENCE ====================
!define MUI_WELCOMEPAGE_TITLE "Welcome to SpeechCraft Studio 1.3.1"
!define MUI_WELCOMEPAGE_TEXT "This wizard installs SpeechCraft Studio v1.3.1 on your computer. SpeechCraft Studio is an accessible audio editor. You'll be asked to pick an edition on the next page: Core (small install, models downloaded on demand) or Full (all models bundled, works offline out of the box). Click Next to continue."
...
!define MUI_FINISHPAGE_TEXT "SpeechCraft Studio 1.3.1 is now installed. Tick the checkboxes below to open the install folder and/or launch SpeechCraft Studio."
...
Section "SpeechCraft Studio" SecMain
    ...
    WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\SpeechCraft Studio" "DisplayVersion" "1.3.1"
